...
#docker kill cliDigiBank cliMagnetoCorp cliDd logspout || true
./network.sh down
./network.sh up createChannel -ca -s couchdb

# Copy the connection profiles so they are in the correct organizations.
cp "${DIR}/../test-network/organizations/peerOrganizations/org1.example.com/connection-org1.yaml" "${DIR}/organization/a/gateway/"
cp "${DIR}/../test-network/organizations/peerOrganizations/org2.example.com/connection-org2.yaml" "${DIR}/organization/b/gateway/"
cp "${DIR}/../test-network/organizations/peerOrganizations/org3.example.com/connection-org3.yaml" "${DIR}/organization/c/gateway/"
cp "${DIR}/../test-network/organizations/peerOrganizations/org4.example.com/connection-org4.yaml" "${DIR}/organization/d/gateway/"
