...
async function main() {
  ...
  try {
    ...
    console.log('Submit warehouse receipt redeem transaction.');

    const redeemResponse = await contract.submitTransaction('redeem', 'B', '00002', 'C', 'C', '2023-11-27');
    ...
    console.log(`${paper.issuer} warehouse receipt : ${paper.paperNumber} successfully redeemed with ${paper.owner}`);
