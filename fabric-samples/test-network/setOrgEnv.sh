...
if [[ ${ORG,,} == "org1" || ${ORG,,} == "a" ]]; then
   ...
   echo "Unknown \"$ORG\", please choose Org1/a or Org2/b or Org3/c or Org4/d"
   ...
   echo 'export $(./setOrgEnv.sh Org3 | xargs)'
   echo 'export $(./setOrgEnv.sh Org4 | xargs)'   
   exit 1
fi
